...
if __name__ == '__main__':
    ...
    if mode == 0:
        ...
        figure(figsize=figsize_dflt)
        plot(tur_eps_all, beta_B, 'r-', marker='s')
        ...
        plot(tur_eps_all, beta_S, 'b-', marker='o')
        plot(tur_eps_all, beta_I, 'g-', marker='v')
        plot(tur_eps_all, beta_drift, 'm-',marker='^')#, markersize = marker_size)
        plot(tur_eps_all, beta_B + beta_S + beta_I + beta_drift, 'm--')#, markersize = marker_size)
        legend(['Brownian', 'Turbulent shearing', 'Turbulent inertia', 'Drift', 'Total'], framealpha=0.5,
